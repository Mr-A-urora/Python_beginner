...
while True:
    ...
    # （2）删除客户（默认姓名不重复）
        ...
        for customer_list in customers:
            if customer_list[0] == del_customer_name:
                customers.remove(customer_list)
    ...
    # （3）修改客户
        ...
        for customer_list in customers:
            if customer_list[0] == update_customer_name:
                new_name = input("请输入修改后的客户的姓名：")
                new_age = input("请输入修改后客户的年龄：")
                new_email = input("请输入修改后的客户的邮箱：")
                customer_list[0] = new_name
                customer_list[1] = new_age
                customer_list[2] = new_email
    ...
    # （4）查看某一个客户
        ...
        for customer_list in customers:
            if customer_list[0] == query_customers_name:
                print(f"姓名：{customer_list[0]}, 年龄：{customer_list[1]}, 邮箱：{customer_list[2]}")
                flag = True
                break
    ...
    # （5）查看每一位客户的信息
        ...
        if customers:
            for customer_list in customers:
                print(f"姓名：{customer_list[0]:^10}, 年龄：{customer_list[1]:^3}, 邮箱：{customer_list[2]:^25}")
        else:
            print("当前没有任何客户信息！")
    # （6）退出系统
    elif choice == "6":
